    ...
    >
      ...
      <div className=" text-center text-neutral-content lg:w-[70%] rounded-3xl p-3 ">
        ...
        <div className="flex flex-col lg:flex-row justify-center gap-8 ">
          <button className="hover:bg-green-500 border-none px-9 text-black  py-4 text-xl  font-semibold bg-green-400 rounded-full ">
            Explore Now
          </button>
          <button className="hover:border-[#0BE58A] px-9  py-4 text-xl font-semibold bg-transparent  border-2 text-white rounded-full">
            Our Feedback
          </button>
        </div>
      </div>
