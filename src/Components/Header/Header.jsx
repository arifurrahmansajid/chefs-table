    ...
    <div className="navbar bg-base-100 container mx-auto my-14">
      <div className="navbar-start">
        <div className="dropdown  lg:hidden">
          ...
          >
            <li className="ink link-hover">Home</li>

            <li className="ink link-hover">Recipe</li>
            <li className="ink link-hover">About</li>
            <li className="ink link-hover">Search</li>
          </ul>
        </div>
        <div className="">
          <h1 className="text-2xl lg:text-4xl  font-bold ml-3">Hungry Bites</h1>
        </div>
      </div>
